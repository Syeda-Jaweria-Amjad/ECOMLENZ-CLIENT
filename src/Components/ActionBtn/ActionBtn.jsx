...
const ActionBtn = ({
  ...
  function handleAnotherTab() {
    setIsAnotherTabOpen(!isAnotherTabOpen);
  }
  const handleMenu = () => {
    setShow((prev) => !prev);
    ...
    <div className="relative" ref={dropdownRef}>
          ...
          {isAnotherTabOpen && (
            <div>
              <div
                ...
                onClick={() =>
                  window.open(
                    `https://www.amazon.com/sp?ie=UTF8&seller=${asin}`,
                    "_blank"
                  )
                }
              >
              ...
              <div
                className="text-sm px-4 py-2 hover:bg-gray-100 rounded cursor-pointer"
                onClick={() =>
                  window.open(`https://keepa.com/#!seller/1-${asin}`, "_blank")
                }
              >
                Keepa
              </div>
              <div
                ...
                onClick={() =>
                  window.open(
                    `https://sas.selleramp.com/sas/lookup?search_term=https%253A%252F%252Fwww.amazon.com%252Fs%253Fi%253Dmerchant-items%2526me%${asin}`,
                    "_blank"
                  )
                }
              >
      ...
      {isEditModelOpen && (
        <EditSellerModal
          ...
          SellerName={SellerName}
          SellerID={SellerID}
          isinsellerdetailmodel={isinsellerdetailmodel}
        />
      )}
    </div>
  );
