...
const loadUserAllSellersAction = (pauseStatus) => async (dispatch) => {
  try {
    ...
    if (pauseStatus) {
      const response = await fetch(
        `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/load-user-all-sellers?pauseStatus=${pauseStatus}`,
        {
          credentials: "include",
        }
      );
      ...
      const response = await fetch(
        "https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/load-user-all-sellers",
        {
          credentials: "include",
        }
      );
...
const addSellerAction = (id) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/api/seller/${id}`,
      {
        credentials: "include",
      }
    );
...
const pauseSellerAction = (id) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/pause-seller/${id}`,
      {
        credentials: "include",
      }
    );
...
const changePasswordAction = (data) => async (dispatch) => {
  try {
    ...
    let response = await fetch("https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/change-password", {
      method: "POST",
      credentials: "include",
      headers: {
...
const editProfileAction = (data) => async (dispatch) => {
  try {
    ...
    let response = await fetch("https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/edit-user", {
      method: "PUT",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
...
const markAsReadAllProductsAction = (id) => async (dispatch) => {
  try {
    ...
    let response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/mark-as-read-new-products/${id}`,
      {
        credentials: "include",
      }
    );
...
const saveSellerAction = (id) => async (dispatch) => {
  try {
    ...
    let response = await fetch(`https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/save-seller/${id}`, {
      credentials: "include",
    });
    response = await response.json();
    dispatch({
...
const editSellerAction = (sellerId, sellerName) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/edit-seller-info/${sellerId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
const deleteSellerAction = (sellerId) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/remove-seller/${sellerId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
const SellerProductAction =
  ...
  async (dispatch) => {
    try {
      ...
      const response = await fetch(
        `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/load-specific-seller-product/${id}?${queryParams}`,
        {
          method: "GET",
          credentials: "include",
        }
...
const loadSellerProductsAction = (params) => async (dispatch) => {
  try {
    ...
    let url = `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/load-seller-products`;
...
const showSavedProduct =
  ...
  async (dispatch) => {
    try {
      ...
      // Base URL for the API
      let url = `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/load-seller-saved-products`;
...
const SaveSellerProductAction = (sellerId, productId) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `https://ecomlenz-erafh6dqcbhac9fz.canadacentral-01.azurewebsites.net/auth/save-product/${sellerId}/${productId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
